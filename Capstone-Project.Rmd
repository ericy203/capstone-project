...
The plot below shows the average years of experience for each NFL team.
```{r}
...
```{r}
ggplot(collegedf2, aes(x = `Rush.Attempts`, y = `Rush.YdsLost`)) +
  geom_point()
```
